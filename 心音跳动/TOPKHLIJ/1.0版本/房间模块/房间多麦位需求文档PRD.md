...
![房间10麦位主界面](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/房间_10麦位.jpg)
...
![房间20麦位主界面](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/房间-20麦位.jpg)
...
![房间菜单](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/房间菜单.jpg)
...
![房间设置页](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/房间设置.jpg)
...
![麦位数量切换流程与确认提示](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/麦位数量切换.jpg)
...
![房间菜单-排麦模式开关](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/房间菜单_排麦模式开关.jpg)

**功能描述：** 房主通过房间菜单中的排麦模式开关进入排麦模式配置。  
**关键交互：** 点击排麦模式开关后，房间进入排麦模式，所有用户视角房间页面底部出现排麦悬浮窗。

![排麦模式-用户视角](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/排麦模式_用户视角.jpg)

**功能描述：** 普通用户视角出现排麦悬浮窗，用于进入申请上麦与排队列表。  
**关键交互：** 用户点击排麦悬浮窗后，进入申请上麦弹窗。

![排麦申请列表](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/排麦申请列表.jpg)

**功能描述：** 普通用户申请上麦页面展示当前排队列表、申请上麦按钮和取消排队状态。  
**关键交互：** 弹窗默认展示排队列表（空则展示缺省图标）与“申请上麦”按钮；用户申请成功后，按钮切换为“取消排队”。

![抱麦页面](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/抱麦.jpg)
...
![房主管理员审批视角](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/排麦模式_房主_管理员视角.jpg)

**功能描述：** 房主与被授权管理员通过审批视图统一处理排麦申请，包括红点提醒、申请列表、同意/拒绝/清空与搜索。  
**关键交互：** 当有新的上麦申请时，审批入口出现红点；进入审批视图后可对用户进行同意、拒绝、清空、搜索等操作。

![麦位选择弹窗](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/排麦申请_选择上麦.jpg)
...
![房间榜单与说明入口](/Users/mac/心音跳动/TOPKHLIJ/1.0版本/房间模块/TOP_khalij房间1.0原型图/房间榜单.jpg)
